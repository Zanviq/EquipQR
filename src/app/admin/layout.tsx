...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="admin-shell">
    ...
    <div className="admin-main"><header className="admin-mobilebar"><Link className="wordmark" href="/admin"><span className="wordmark-mark">EQ</span>EquipQR</Link><AdminNav /><Link href="/scan">직원 화면</Link></header>{children}</div>
  </div>;
}
